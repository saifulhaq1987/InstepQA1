...
TC_name = CustomKeywords.'com.oracledb.regressiontest.genName'(10)
...
WebUI.click(findTestObject('TF_Product_Create/4_Create_Objects_And_Save/2-1-Create_Total_company/Click_ToggleImageCheck_Planning-Product'))

WebUI.delay(3)

WebUI.click(findTestObject('TF_Product_Create/4_Create_Objects_And_Save/2-1-Create_Total_company/Click_addbttn_Planning-Product'))
...
WebUI.doubleClick(findTestObject('TF_Product_Create/4_Create_Objects_And_Save/2-1-Create_Total_company/td_dblclick_SelectData_Planning-Product'))
