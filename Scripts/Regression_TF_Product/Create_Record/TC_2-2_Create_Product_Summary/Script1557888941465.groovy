...
WebUI.click(findTestObject('TF_Product_Create/2_Select_Menu_Options(All)/Product Hierarchy Level/td_Product_summary'))

WebUI.waitForPageLoad(GlobalVariable.G_Timeout)

WebUI.delay(3)

TPS_name = CustomKeywords.'com.oracledb.regressiontest.genName'(10)

WebUI.setText(findTestObject('TF_Product_Create/4_Create_Objects_And_Save/2-2- Product Summary/input_Total_Product-Summary_Name'), 
    TPS_name)
...
WebUI.click(findTestObject('TF_Product_Create/4_Create_Objects_And_Save/2-2- Product Summary/Click_ToggleImageCheck_Planning-Product'))

WebUI.delay(3)

WebUI.click(findTestObject('TF_Product_Create/4_Create_Objects_And_Save/2-2- Product Summary/Click_addbttn_Planning-Product'))
...
WebUI.doubleClick(findTestObject('TF_Product_Create/4_Create_Objects_And_Save/2-2- Product Summary/td_dblclick_SelectData_Planning-Product'))
